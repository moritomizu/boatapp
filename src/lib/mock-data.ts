...
export const mockData: AppData = {
  organization: {
    ...
    description: "TaPiYoTa Grand Boat Clubの共同保有艇運用組織",
    ownerUserId: "user-admin",
    contact: "090-0000-0000 / admin@example.com",
    activityArea: "大阪湾・淀川河口周辺",
    ruleSummary: "月3回程度、出船前後チェック必須。安全判断を最優先します。",
  ...
  currentOrganizationId: "org-osaka-tapiyota",
  currentBoatId: "boat-tapiyota",
  ...
  organizationMembers: [
    ...
    },
    {
      ...
      isActive: true,
      createdAt: "2026-05-04T09:00:00.000+09:00",
      updatedAt: "2026-05-04T09:00:00.000+09:00",
    },
  ],
  organizationRules: [
    {
      id: "rules-org-osaka-tapiyota",
      organizationId: "org-osaka-tapiyota",
      ...
      strictLimit: false,
      ruleText:
        "予約は先着順です。出船前チェックと帰港後チェックを必ず行い、気になる点は申し送りへ残してください。",
      notes: "悪天候時は無理に出船せず、相談サポートで共有してください。",
      emergencyContact: "緊急時は海上保安庁118番、マリーナ、管理者へ直接連絡してください。",
      createdAt: "2026-05-01T00:00:00.000+09:00",
  ...
  organizationInvites: [
    {
      ...
      role: "member",
      inviteCode: "TAPIYOTA2026",
      status: "pending",
      memo: "実運用テスト用の招待コード",
      invitedBy: "user-admin",
      expiresAt: "2026-12-31T23:59:59.000+09:00",
      createdAt: "2026-06-01T00:00:00.000+09:00",
      updatedAt: "2026-06-01T00:00:00.000+09:00",
    },
  ],
  ...
  boatOwnerships: [
    {
      id: "ownership-tapiyota-admin",
      organizationId: "org-osaka-tapiyota",
      boatId: "boat-tapiyota",
      ownerUserId: "user-admin",
      ownerName: "TaPiYoTa共同オーナー",
      ownershipType: "co_owner",
      ownershipSharePercent: 50,
      isPayoutRecipient: true,
      payoutSharePercent: 50,
      payoutMemo: "共同所有者向けの還元先。振込情報は別途管理。",
      adminMemo: "実証運用中のため月次確定時に手動調整。",
      createdAt: "2026-06-01T00:00:00.000+09:00",
      updatedAt: "2026-06-01T00:00:00.000+09:00",
    },
    {
      id: "ownership-tapiyota-owner-1",
      organizationId: "org-osaka-tapiyota",
      boatId: "boat-tapiyota",
      ...
      isPayoutRecipient: true,
      payoutSharePercent: 50,
      payoutMemo: "共同所有者向けの還元先。",
      adminMemo: "",
      createdAt: "2026-06-01T00:00:00.000+09:00",
      updatedAt: "2026-06-01T00:00:00.000+09:00",
    },
    {
      id: "ownership-second-owner",
      organizationId: "org-osaka-tapiyota",
      boatId: "boat-second",
      ownerUserId: "user-owner-1",
      ownerName: "第2タピヨタ船主",
      ownershipType: "partner_owner",
      ownershipSharePercent: 100,
      isPayoutRecipient: true,
      payoutSharePercent: 100,
      payoutMemo: "パートナー艇の還元先。",
      adminMemo: "ライト不具合確認中。",
      createdAt: "2026-06-01T00:00:00.000+09:00",
      updatedAt: "2026-06-01T00:00:00.000+09:00",
    },
  ...
  membershipPlans: [
    {
      ...
      organizationId: "org-osaka-tapiyota",
      name: "スタンダード会員",
      description: "月2〜3回程度の利用を想定した基本プラン。",
      monthlyFee: 15000,
      monthlyReservationLimit: 3,
      weekendReservationLimit: 2,
      accessibleBoatIds: ["boat-tapiyota", "boat-second"],
      canGuestUse: true,
      canNightUse: false,
      canEventUse: false,
      isActive: true,
    ...
    },
    {
      ...
      organizationId: "org-osaka-tapiyota",
      name: "共同オーナー",
      description: "共同保有オーナー向け。個別合意を月次確定で反映。",
      monthlyFee: 25000,
      monthlyReservationLimit: 4,
      weekendReservationLimit: 3,
      accessibleBoatIds: ["boat-tapiyota", "boat-second"],
      canGuestUse: true,
      canNightUse: true,
      canEventUse: true,
  ...
  memberSubscriptions: [
    {
      ...
      organizationId: "org-osaka-tapiyota",
      userId: "user-admin",
      membershipPlanId: "plan-owner",
      status: "active",
      startedAt: "2026-06-01T00:00:00.000+09:00",
      monthlyFeeSnapshot: 25000,
      planNameSnapshot: "共同オーナー",
      createdAt: "2026-06-01T00:00:00.000+09:00",
      updatedAt: "2026-06-01T00:00:00.000+09:00",
    },
    {
      id: "subscription-owner-1",
      organizationId: "org-osaka-tapiyota",
      userId: "user-owner-1",
      membershipPlanId: "plan-owner",
      status: "active",
    ...
    },
    {
      ...
      status: "active",
      startedAt: "2026-06-01T00:00:00.000+09:00",
      monthlyFeeSnapshot: 15000,
      planNameSnapshot: "スタンダード会員",
      createdAt: "2026-06-01T00:00:00.000+09:00",
      updatedAt: "2026-06-01T00:00:00.000+09:00",
    },
  ],
  boatRevenuePolicies: [
    {
      ...
      memo: "初期値。月次確定時に管理者が調整。",
      createdAt: "2026-06-01T00:00:00.000+09:00",
      updatedAt: "2026-06-01T00:00:00.000+09:00",
    },
    {
      id: "revenue-policy-second",
      organizationId: "org-osaka-tapiyota",
      boatId: "boat-second",
      ownerReturnRate: 40,
      operationFeeRate: 30,
  ...
  fundTransactions: [
    {
      ...
      costResponsibility: "boat_maintenance_fund",
      description: "月次配分からのメンテ積立",
      relatedBoatId: "boat-tapiyota",
      adminMemo: "初期サンプル",
      createdAt: "2026-06-01T00:00:00.000+09:00",
    ...
    },
    {
      ...
      costResponsibility: "boat_maintenance_fund",
      description: "定期メンテナンス支出",
      relatedBoatId: "boat-tapiyota",
      relatedMaintenanceLogId: "maint-001",
      adminMemo: "オイル交換関連",
      createdAt: "2026-06-02T10:00:00.000+09:00",
      createdBy: "user-admin",
    },
    {
      id: "fund-tx-003",
      organizationId: "org-osaka-tapiyota",
      fundType: "organization_safety",
      type: "contribution",
      amount: 70000,
      reason: "monthly_allocation",
      costResponsibility: "organization_safety_fund",
      description: "共通安全基金への月次積立",
      adminMemo: "安全備品用",
      createdAt: "2026-06-01T00:00:00.000+09:00",
      createdBy: "user-admin",
    },
    {
      ...
      type: "expense",
      amount: 20000,
      reason: "safety_equipment",
      costResponsibility: "organization_safety_fund",
      description: "予備ライフジャケット購入",
      adminMemo: "共通安全備品",
      createdAt: "2026-06-03T10:00:00.000+09:00",
      createdBy: "user-admin",
    },
  ],
...
export const createReservation = (
  ...
  return {
    ...reservation,
    sessionStatus: reservation.sessionStatus ?? "scheduled",
